...
import com.withcodeplays.photoediting.EmojiBSFragment.EmojiListener
import com.withcodeplays.photoediting.StickerBSFragment.StickerListener
import com.withcodeplays.photoediting.base.BaseActivity
import com.withcodeplays.photoediting.filters.FilterListener
import com.withcodeplays.photoediting.filters.FilterViewAdapter
import com.withcodeplays.photoediting.tools.EditingToolsAdapter
import com.withcodeplays.photoediting.tools.EditingToolsAdapter.OnItemSelected
import com.withcodeplays.photoediting.tools.ToolType
...
class EditImageActivity : BaseActivity(), OnPhotoEditorListener, View.OnClickListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        window?.navigationBarColor = R.color.purple_500
        initViews()
    ...
    private fun saveImage(mainValue: String) {
        val fileName = "$mainValue.png"
    ...
    private fun getFileName() {
        val dilaogs = AddNumberFragment().apply {
            setAddNumberListener { mainValue, _, _ ->
                saveImage(mainValue)
            }
        }

        dilaogs.show(supportFragmentManager,"AddingFileName")

    }

    @SuppressLint("MissingPermission")
    private fun showSaveDialog() {
        val builder = AlertDialog.Builder(this, R.style.WelcomeStyle)
        builder.setMessage(getString(R.string.msg_save_image))
        builder.setPositiveButton("Save") { _: DialogInterface?, _: Int -> getFileName() }
