...
public abstract class ActivityEditImageBinding extends ViewDataBinding {
  ...
  protected ActivityEditImageBinding(Object _bindingComponent, View _root, int _localFieldCount,
      ...
      ConstraintLayout rootView, ConstraintLayout rootViews, RecyclerView rvConstraintTools,
      RecyclerView rvFilterView, TextView txtCurrentTool, ImageView userAddImage) {
  ...
  @NonNull
  public static ActivityEditImageBinding inflate(@NonNull LayoutInflater inflater,
   ...
   * @Deprecated Use DataBindingUtil.inflate(inflater, R.layout.activity_edit_image, root, attachToRoot, component)
   */
  @NonNull
  @Deprecated
  public static ActivityEditImageBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable ViewGroup root, boolean attachToRoot, @Nullable Object component) {
    return ViewDataBinding.<ActivityEditImageBinding>inflateInternal(inflater, R.layout.activity_edit_image, root, attachToRoot, component);
  }
   ...
   * compilation fails for another reason.
   * https://issuetracker.google.com/issues/116541301
   * @Deprecated Use DataBindingUtil.inflate(inflater, R.layout.activity_edit_image, null, false, component)
   */
  @NonNull
  @Deprecated
  public static ActivityEditImageBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable Object component) {
    return ViewDataBinding.<ActivityEditImageBinding>inflateInternal(inflater, R.layout.activity_edit_image, null, false, component);
  }
   ...
   */
  @Deprecated
  public static ActivityEditImageBinding bind(@NonNull View view, @Nullable Object component) {
    return (ActivityEditImageBinding)bind(component, view, R.layout.activity_edit_image);
  }
}
