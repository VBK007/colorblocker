 ...
 */
public abstract class Hilt_AddNumberFragment extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddNumberFragment() {
    super();
  }

  Hilt_AddNumberFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddNumberFragment_GeneratedInjector) this.generatedComponent()).injectAddNumberFragment(UnsafeCasts.<AddNumberFragment>unsafeCast(this));
    }
  }
